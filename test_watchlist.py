...
class WatchlistTestCase(unittest.TestCase):
    ...
    def test_index_page(self):
        ...
        self.assertIn('Test Book Title', data)
...
class WatchlistTestCase(unittest.TestCase):
    ...
    def test_update_item(self):
        ...
        self.assertIn('Test Book Title', data)
        self.assertIn('Test Author', data)
        ...
        self.assertIn('New Author Edited', data)
        ...
        # 测试更新条目操作，但作者为空
        response = self.client.post('/book/edit/1', data=dict(
            title='New Book Edited Again',
            author=''
        ), follow_redirects=True)
        data = response.get_data(as_text=True)
        self.assertNotIn('Item updated.', data)
        self.assertNotIn('New Book Edited Again', data)
        self.assertIn('Invalid input.', data)
    ...
    def test_delete_item(self):
        ...
        self.assertNotIn('Test Book Title', data)
